...
<body>
		<%
			...
			TrainSchedule[] searchedSchedules = (TrainSchedule[])sesh.getAttribute("searchedSchedules");
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					<td>
						<a href="/TrainApp/EmployeeViews/sendSearchedSchedule.jsp?index=<%= i %>" class="btn btn-link">
